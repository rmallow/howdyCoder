...
class Ui_CreateFinalConfirm(object):
    def setupUi(self, CreateFinalConfirm):
        if not CreateFinalConfirm.objectName():
            CreateFinalConfirm.setObjectName(u"CreateFinalConfirm")
        ...
        self.config_text_view.setObjectName(u"config_text_view")
    ...
    def retranslateUi(self, CreateFinalConfirm):
        CreateFinalConfirm.setWindowTitle(QCoreApplication.translate("CreateFinalConfirm", u"CreateFinalConfirm", None))
        self.label.setText(QCoreApplication.translate("CreateFinalConfirm", u"The final config. Hit start over to start new with a new config or hit finish to add this algo.", None))
    # retranslateUi
