...
from PySide6.QtWidgets import (QApplication, QGraphicsView, QHBoxLayout, QHeaderView,
    QLabel, QSizePolicy, QTableView, QTextEdit,
    QVBoxLayout, QWidget)
...
class Ui_CreateBuiltInAction(object):
    def setupUi(self, CreateBuiltInAction):
        ...
        self.widget_2 = QWidget(CreateBuiltInAction)
        ...
        self.graphicsView = QGraphicsView(self.widget_3)
        ...
        self.input_table_box = QWidget(self.widget_2)
        ...
        self.tableView = QTableView(self.input_table_box)
    ...
    def retranslateUi(self, CreateBuiltInAction):
        ...
        self.textEdit.setPlaceholderText(QCoreApplication.translate("CreateBuiltInAction", u"Enter your text here.", None))
