...
################################################################################
## Form generated from reading UI file 'createStandardDataSource.ui'
##
...
class Ui_CreateStandardDataSource(object):
    def setupUi(self, CreateStandardDataSource):
        if not CreateStandardDataSource.objectName():
            CreateStandardDataSource.setObjectName(u"CreateStandardDataSource")
        CreateStandardDataSource.resize(785, 609)
        self.verticalLayout = QVBoxLayout(CreateStandardDataSource)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.label = QLabel(CreateStandardDataSource)
        ...
        self.stackedWidget = QStackedWidget(CreateStandardDataSource)
        ...
        self.output_box = QWidget(CreateStandardDataSource)
        ...
        self.retranslateUi(CreateStandardDataSource)

        QMetaObject.connectSlotsByName(CreateStandardDataSource)
    # setupUi

    def retranslateUi(self, CreateStandardDataSource):
        CreateStandardDataSource.setWindowTitle(QCoreApplication.translate("CreateStandardDataSource", u"CreateStandardDataSource", None))
        self.label.setText(QCoreApplication.translate("CreateStandardDataSource", u"Setup Data Source", None))
        self.label_3.setText(QCoreApplication.translate("CreateStandardDataSource", u"Determine Output", None))
        self.outputHelpText.setText(QCoreApplication.translate("CreateStandardDataSource", u"The AI will do its best to determine what data the function wil output. You will then need to input these suggestions into the bottom table using the add/remove buttons.\n"
"Ocassionally the AI will not give the output, or wrong output, you will need to look at the return value of the function to determine the output in this case. Consult the user manual for more info.", None))
        self.label_2.setText(QCoreApplication.translate("CreateStandardDataSource", u"Output Suggestions:", None))
        self.addOutputButton.setText(QCoreApplication.translate("CreateStandardDataSource", u"Add", None))
        self.removeOutputButton.setText(QCoreApplication.translate("CreateStandardDataSource", u"Remove", None))
    # retranslateUi
