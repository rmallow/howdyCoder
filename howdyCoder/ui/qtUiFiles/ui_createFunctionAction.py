...
class Ui_CreateFunctionAction(object):
    def setupUi(self, CreateFunctionAction):
        ...
        sizePolicy.setHeightForWidth(self.suggested_data_box_widget.sizePolicy().hasHeightForWidth())
        self.suggested_data_box_widget.setSizePolicy(sizePolicy)
        ...
        sizePolicy4.setHeightForWidth(self.suggested_data_set.sizePolicy().hasHeightForWidth())
        self.suggested_data_set.setSizePolicy(sizePolicy4)
