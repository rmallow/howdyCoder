...
class Ui_GlobalParameterPageWidget(object):
    def setupUi(self, GlobalParameterPageWidget):
        ...
        sizePolicy5.setHeightForWidth(self.all_parameter_table_view.sizePolicy().hasHeightForWidth())
        self.all_parameter_table_view.setSizePolicy(sizePolicy5)
    ...
    def retranslateUi(self, GlobalParameterPageWidget):
        ...
        self.label_4.setText(QCoreApplication.translate("GlobalParameterPageWidget", u"Set Howdy Coder API Key", None))
