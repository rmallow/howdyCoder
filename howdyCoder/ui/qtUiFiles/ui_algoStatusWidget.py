...
class Ui_AlgoStatusWidget(object):
    def setupUi(self, AlgoStatusWidget):
        ...
        AlgoStatusWidget.setMaximumSize(QSize(566, 250))
        ...
        self.name_label.setMinimumSize(QSize(0, 24))
        font = QFont()
        ...
        self.logging_list_widget.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.logging_list_widget.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
