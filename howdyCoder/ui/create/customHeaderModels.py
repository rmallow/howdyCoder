...
class CustomHeaderLOLModel(QtCore.QAbstractTableModel):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._table: typing.List[typing.List[typing.Any]] = [[]]
    ...
    def setTable(self, new_table: typing.List[typing.List[typing.Any]]):
        self.beginResetModel()
                ...
                if self._custom_header_added:
                    if self._custom_header_is_first_row:
                        ...
                        if col == 0:
                            ...
                            col -= 1
                return str(self._table[row][col])
        return None
...
class CustomHeaderPandaModel(QtCore.QAbstractTableModel):
    ...
    def setTable(self, new_data_frame: pd.DataFrame):
        self.beginResetModel()
