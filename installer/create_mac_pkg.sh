python -m pyclean ../
/usr/local/bin/platypus -B -R -y -i '../howdyCoder/ui/res/MyIcon.icns'  -a 'HowdyCoder'  -o 'None'  -p '/bin/sh'   -I com.rmallow.HowdyCoder -f '../main.py' -f '../requirements.txt' -f '../howdyCoder'  'start_mac.sh'
codesign --deep -s "Developer ID Application" -o runtime HowdyCoder.app
